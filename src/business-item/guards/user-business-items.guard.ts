...
@Injectable()
export class UserBusinessItemsGuard implements CanActivate {
  private readonly logger = new Logger(UserBusinessItemsGuard.name);
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Check for superadmin role - they can access all business items
    ...
    // Check for businessitem:manage:any claim - they can access all business items
    ...
    // accessing only their own business items, using their business profile IDs
    return true;
  }
} 