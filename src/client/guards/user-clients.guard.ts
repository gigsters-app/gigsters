...
@Injectable()
export class UserClientsGuard implements CanActivate {
  private readonly logger = new Logger(UserClientsGuard.name);
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Check for superadmin role - they can access all clients
    ...
    // Check for client:manage:any claim - they can access all clients
    ...
    // accessing only their own clients, using their business profile IDs
    return true;
  }
} 